    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardGroundfloor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), LaboratoryDataModel.class).putExtra("floor", "ground floor"));
            }
        });
        cardFirstFloor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), LaboratoryDataModel.class).putExtra("floor", "first floor"));
            }
        });
        cardsecond.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), LaboratoryDataModel.class).putExtra("floor", "second floor"));
            }
        });
        cardThirdFloor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), LaboratoryDataModel.class).putExtra("floor", "third floor"));
            }
        });
    }
}